...
_COLLECTION_TAGSENTRY = _descriptor.Descriptor(
  name='TagsEntry',
  full_name='example.Collection.TagsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='example.Collection.TagsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='example.Collection.TagsEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COLLECTION = _descriptor.Descriptor(
  name='Collection',
  full_name='example.Collection',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tags', full_name='example.Collection.tags', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='names', full_name='example.Collection.names', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='categories', full_name='example.Collection.categories', index=2,
  ...
  nested_types=[_COLLECTION_TAGSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_COLLECTION_TAGSENTRY.containing_type = _COLLECTION
_COLLECTION.fields_by_name['tags'].message_type = _COLLECTION_TAGSENTRY
_COLLECTION.fields_by_name['categories'].message_type = _CATEGORY
...
Collection = _reflection.GeneratedProtocolMessageType('Collection', (_message.Message,), {
  ...
  'TagsEntry' : _reflection.GeneratedProtocolMessageType('TagsEntry', (_message.Message,), {
    'DESCRIPTOR' : _COLLECTION_TAGSENTRY,
    '__module__' : 'example_pb2'
    # @@protoc_insertion_point(class_scope:example.Collection.TagsEntry)
    })
  ,
  'DESCRIPTOR' : _COLLECTION,
  '__module__' : 'example_pb2'
  # @@protoc_insertion_point(class_scope:example.Collection)
  })
_sym_db.RegisterMessage(Collection)
_sym_db.RegisterMessage(Collection.TagsEntry)
...
_COLLECTION_TAGSENTRY._options = None
